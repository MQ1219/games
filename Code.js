class Code{
    ...
    checkpos(position){
    	 return this.position.some(element=>Math.abs(element-position)<=60)
    }
	getChar(){
		...
		divs.style.cssText = `width:60px;height:60px;color:#fff;
							font-size:0px;text-align:center;line-height:60px;
